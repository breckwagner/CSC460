...
void signal_start_task (uint8_t value) {
  switch (value) {
    case 0: PORTL ^= (1<<PL3); PORTL ^= (1<<PL3); break;
    case 1: PORTL ^= (1<<PL2); PORTL ^= (1<<PL2); break;
    case 2: PORTL ^= (1<<PL1); PORTL ^= (1<<PL1); break;
    case 3: PORTL ^= (1<<PL0); PORTL ^= (1<<PL0); break;
    case 4: PORTB ^= (1<<PB3); PORTL ^= (1<<PB3); break;
    case 5: PORTB ^= (1<<PB2); PORTL ^= (1<<PB2); break;
    case 6: PORTB ^= (1<<PB1); PORTL ^= (1<<PB1); break;
    case 7: PORTB ^= (1<<PB0); PORTL ^= (1<<PB0); break;
  }
}
